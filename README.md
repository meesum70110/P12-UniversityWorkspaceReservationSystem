...
You can access the live version of the Workspace Reservation web application hosted on Render by following this link: https://workspacereservation-front.onrender.com/
Credentials:
Admin Login
...
•	Frontend: https://workspacereservation-front.onrender.com
•	Backend: https://workspacereservation-backend.onrender.com

Features
1.	User Authentication:
o	Users and admins can log in with their respective credentials.
o	Admin and user roles are separated, each having access to different functionalities.
o	Passwords are securely stored in the database.
o	Prompts for Incorrect email, Incorrect password.
o	Logout Functionality within Web App. You can log out at any time.
 

2.	Admin Dashboard:
o	Admins can add, modify, or delete workspaces.
o	Admins can view My Account, a list of all users (user records) and search by department or email.
o	Admins can manage user records, including updating details or deleting accounts.


3.	User Dashboard:
o	User can Login with your user credentials.
o	View available workspaces, reserve, or cancel reservations.
o	Access FAQs for help regarding the application.

 

4.	Workspace Reservation:
o	Admins can add, modify, or delete workspaces.
o	Users can view available workspaces and reserve them.
o	Users can filter workspaces by location and availability status.
o	Workspaces can be booked for specific time slots (for future use).
o	Users can modify or cancel reservations as per the defined policy (for future).
 


5.	FAQ Management:
o	Admins can add, modify, or delete frequently asked questions (FAQs) visible to users.
o	Users can access FAQs to get quick answers regarding reservations, modifications, and cancellations.


. Collapsible Sidebar menu dropdown & Sliding bar (in bottom) for options visibility:
