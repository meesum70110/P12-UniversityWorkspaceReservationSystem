...
import Employee from './components/TA';
  ...
  return (
    <BrowserRouter>
        <Routes>
          ...
          <Route path="/TA" element={userAccount && userAccount.occupation === 'employee' ? <Employee/> : <Navigate to="/login"/>}/>

          {/* Route for login page */}
          <Route path="/login" element={!userAccount ? <Login/> : <Navigate to={userAccount.occupation === 'admin' ? "/" : "/TA"}/>}/> 
